...
def render(
    ...
    base_video = (
        ...
        "eq=brightness=-0.10:contrast=1.30:saturation=0.20:gamma=0.80,"
        "colorbalance=rs=-0.10:gs=-0.04:bs=0.12,"
        "vignette=PI/3.2:eval=frame,"
        "unsharp=5:5:0.32:5:5:0.0,"
        "noise=alls=7:allf=t+u,split=2[clean][captionbase];"
        "[captionbase]crop=1080:420:0:750,boxblur=luma_radius=16:luma_power=2,"
        "eq=brightness=-0.10,format=rgba,colorchannelmixer=aa=0.72[captionblur];"
        "[clean][captionblur]overlay=0:750,"
